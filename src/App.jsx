    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          <img src={iconSedans} alt="ícones dos carros Sedans" className="mb-7" />
        ...
        <div className="bg-green p-12">
          <img src={iconSuvs} alt="ícone de carro SUVs" className="mb-7" />
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          <img src={iconLuxury} alt="ícone de carros de luxo" className="mb-7"/>
